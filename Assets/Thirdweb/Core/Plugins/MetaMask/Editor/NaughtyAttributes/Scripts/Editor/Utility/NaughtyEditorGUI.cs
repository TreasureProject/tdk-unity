...
namespace MetaMask.Editor.NaughtyAttributes.Editor
{
    public static class NaughtyEditorGUI
    {
        ...
        public static bool PropertyField(Rect rect, SerializedProperty property, bool includeChildren)
        {
            return PropertyField_Implementation(rect, property, includeChildren, DrawPropertyField);
        }

        public static bool PropertyField_Layout(SerializedProperty property, bool includeChildren)
        {
            Rect dummyRect = new Rect();
            return PropertyField_Implementation(dummyRect, property, includeChildren, DrawPropertyField_Layout);
        }
        ...
        private static bool PropertyField_Implementation(Rect rect, SerializedProperty property, bool includeChildren, PropertyFieldFunction propertyFieldFunction)
        {
            SpecialCaseDrawerAttribute specialCaseAttribute = PropertyUtility.GetAttribute<SpecialCaseDrawerAttribute>(property);
            if (specialCaseAttribute != null)
            {
                return specialCaseAttribute.GetDrawer().OnGUI(rect, property);
            }
            else
            {
                // Check if visible
                ...
                {
                    isValid &= validatorAttribute.GetValidator().ValidateProperty(property);
                }
