...
namespace WalletConnect.UnityBinder
{
    /// <summary>
    ...
    public class BindResource : Binder
    {
        ...
        public static MethodInfo GenericResourceLoad
        {
            get
            {
                ...
                foreach (var method in methods)
                {
                    if (method.Name != "Load" || !method.IsGenericMethod)
                        continue;
        ...
        public override void InjectInto(Object obj, FieldInfo field)
        {
            ...
            else if (rawResult is object[])
            {
                ...
                if (result.Length > 0)
                {
                    ...
                    {
                        Debug.LogError("Could not find object of type " + injectType + " for field " + field.Name + " at index " + index);
                    }
                    else
                    {
                ...
                {
                    Debug.LogError("Could not find object of type " + injectType + " for field " + field.Name + " in " + obj.name);
                }
            }
        }
    }
    ...
    public class BindComponentsInChildren : Binder
    {
        ...
        public override void InjectInto(Object obj, FieldInfo field)
        {
            ...
            else if (rawResult is object[])
            {
                ...
                {
                    MethodInfo convertMethod = typeof(BindComponentsInChildren).GetMethod("ConvertArray", BindingFlags.NonPublic | BindingFlags.Static);
