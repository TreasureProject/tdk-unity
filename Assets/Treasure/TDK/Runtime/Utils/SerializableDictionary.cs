...
public abstract class TreasureSerializableDictionaryBase
{
...
[Serializable]
public abstract class TreasureSerializableDictionaryBase<TKey, TValue, TValueStorage> : TreasureSerializableDictionaryBase, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
{
    Dictionary<TKey, TValue> m_dict;
    [SerializeField] TKey[] m_keys;
    [SerializeField] TValueStorage[] m_values;

    public TreasureSerializableDictionaryBase()
    {
        m_dict = new Dictionary<TKey, TValue>();
    }

    public TreasureSerializableDictionaryBase(IDictionary<TKey, TValue> dict)
    {
    ...
    protected TreasureSerializableDictionaryBase(SerializationInfo info, StreamingContext context) 
    {
...
public static class TreasureSerializableDictionary
{
    public class Storage<T> : TreasureSerializableDictionaryBase.Storage
    {
        public T data;
    }
}

public class TreasureSerializableDictionary<TKey, TValue> : TreasureSerializableDictionaryBase<TKey, TValue, TValue>
{
    public TreasureSerializableDictionary() {}
    public TreasureSerializableDictionary(IDictionary<TKey, TValue> dict) : base(dict) {}
    protected TreasureSerializableDictionary(SerializationInfo info, StreamingContext context) : base(info, context) {}
...
public class TreasureSerializableDictionary<TKey, TValue, TValueStorage> : TreasureSerializableDictionaryBase<TKey, TValue, TValueStorage> where TValueStorage : TreasureSerializableDictionary.Storage<TValue>, new()
{
    public TreasureSerializableDictionary() {}
    public TreasureSerializableDictionary(IDictionary<TKey, TValue> dict) : base(dict) {}
    protected TreasureSerializableDictionary(SerializationInfo info, StreamingContext context) : base(info, context) {}
